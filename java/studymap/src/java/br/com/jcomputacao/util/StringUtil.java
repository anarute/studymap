...
//        cpf = cpf.replace(".", "").replace("-", "").replace("/", "").replace(" ", "");
    ...
    public static String formataDataProSQL(Date data) {
        //formata a data do padrão sql para o padrão brasileiro
        if (data != null) {
            SimpleDateFormat formatador = new SimpleDateFormat("yyyy-MM-dd");
            String novaDataFormatada = formatador.format(data);
    ...
    public static Date toDate(String data){
        ...
        try {
            ...
            Logger.getLogger(StringUtil.class.getName()).log(Level.SEVERE, "Erro na conversão de datas", ex);
        }
